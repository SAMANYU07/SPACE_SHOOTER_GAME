...
bool projectile_spr_draw = 0;
bool projectile_spr_shoot = 0;
bool set1_spawned = 0;
int miss_counter = 0;
...
sf::RectangleShape player_health1(sf::Vector2f(40, 40));
sf::RectangleShape player_health2(sf::Vector2f(40, 40));
sf::RectangleShape player_health3(sf::Vector2f(40, 40));
sf::RectangleShape player_health4(sf::Vector2f(40, 40));
...
{
        srand(time(NULL));
        sf::Vector2f asteroid1_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
...
{
        srand(time(NULL));
        sf::Vector2f asteroid2_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid2.setPosition(asteroid2_pos);
}
void reset_ast3()
{
        srand(time(NULL));
        sf::Vector2f asteroid3_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid3.setPosition(asteroid3_pos);
}
void reset_ast4()
{
        srand(time(NULL));
        sf::Vector2f asteroid4_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid4.setPosition(asteroid4_pos);
}
void reset_ast5()
{
        srand(time(NULL));
        sf::Vector2f asteroid5_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid5.setPosition(asteroid5_pos);
}
void reset_ast6()
{
        srand(time(NULL));
        sf::Vector2f asteroid6_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid6.setPosition(asteroid6_pos);
}
void reset_ast7()
{
        srand(time(NULL));
        sf::Vector2f asteroid7_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid7.setPosition(asteroid7_pos);
}
void reset_ast8()
{
        srand(time(NULL));
        sf::Vector2f asteroid8_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
        asteroid8.setPosition(asteroid8_pos);
}
void reset_ast9()
{
        srand(time(NULL));
        sf::Vector2f asteroid9_pos = sf::Vector2f(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
...
void spawn_ast()
{
        ...
        for (int i = 0; i < 9; i++)
        {
                if (i == 0)
                {
                        asteroid1.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 1)
                {
                        asteroid2.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 2)
                {
                        asteroid3.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 3)
                {
                        asteroid4.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 4)
                {
                        asteroid5.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 5)
                {
                        asteroid6.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 6)
                {
                        asteroid7.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 7)
                {
                        asteroid8.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
                if (i == 8)
                {
                        asteroid9.setPosition(sf::VideoMode::getDesktopMode().width + (rand() % 4000), rand()% sf::VideoMode::getDesktopMode().height);
                }
...
void projectile_spr_reset()
{
        projectile_spr.setPosition(player.getPosition().x, player.getPosition().y);
        projectile_spr_shoot = 0;
}
...
int main()
{
        ...
        //asteroid1.setFillColor(sf::Color(0,0,255));
        sf::Texture asteroid1_texture;
        if (!asteroid1_texture.loadFromFile("textures/stonep1.png"))
        {
                std::cout << "Couldn't load asteroid1_texture" << std::endl;
        }
        asteroid1.setTexture(&asteroid1_texture);
        sf::Texture asteroid2_texture;
        if (!asteroid2_texture.loadFromFile("textures/stonep2.png"))
        {
                std::cout << "Couldn't load asteroid2_texture" << std::endl;
        }
        asteroid2.setTexture(&asteroid2_texture);
        sf::Texture asteroid3_texture;
        if (!asteroid3_texture.loadFromFile("textures/stonep3.png"))
        {
                std::cout << "Couldn't load asteroid3_texture" << std::endl;
        }
        asteroid3.setTexture(&asteroid3_texture);
        sf::Texture asteroid4_texture;
        if (!asteroid4_texture.loadFromFile("textures/stonep4.png"))
        {
                std::cout << "Couldn't load asteroid4_texture" << std::endl;
        }
        asteroid4.setTexture(&asteroid4_texture);
        sf::Texture asteroid5_texture;
        if (!asteroid5_texture.loadFromFile("textures/stonep5.png"))
        {
                std::cout << "Couldn't load asteroid5_texture" << std::endl;
        }
        asteroid5.setTexture(&asteroid5_texture);
        sf::Texture asteroid6_texture;
        if (!asteroid6_texture.loadFromFile("textures/stonep1.png"))
        {
                std::cout << "Couldn't load asteroid6_texture" << std::endl;
        }
        asteroid6.setTexture(&asteroid6_texture);
        sf::Texture asteroid7_texture;
        if (!asteroid7_texture.loadFromFile("textures/stonep2.png"))
        {
                std::cout << "Couldn't load asteroid7_texture" << std::endl;
        }
        asteroid7.setTexture(&asteroid7_texture);
        sf::Texture asteroid8_texture;
        if (!asteroid8_texture.loadFromFile("textures/stonep3.png"))
        {
                std::cout << "Couldn't load asteroid8_texture" << std::endl;
        }
        asteroid8.setTexture(&asteroid8_texture);
        sf::Texture asteroid9_texture;
        if (!asteroid9_texture.loadFromFile("textures/stonep4.png"))
        {
                std::cout << "Couldn't load asteroid9_texture" << std::endl;
        }
        asteroid9.setTexture(&asteroid9_texture);
        ...
        while (win.isOpen())
        {
                ...
                if (projectile_spr_draw)
                {
                        win.draw(projectile_spr);
                        if (!projectile_spr_shoot)
                        {
                                projectile_spr.setPosition(player.getPosition().x, player.getPosition().y);
                        }
                        projectile_spr_shoot = 1;
                }
                if (projectile_spr_shoot)
                {
                        projectile_spr.move(1, 0);
                }
                /*if (projectile_shoot)
                {
                        projectile.move(1,0);
                }*/
                if (projectile_spr.getPosition().x > 1360)
                {
                        projectile_spr_draw = 0;
                        projectile_spr_reset();
                        projectile_spr_shoot = 0;
                }
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid1.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast1();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid2.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast2();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid3.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast3();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid4.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast4();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid5.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast5();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid6.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast6();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid7.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast7();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid8.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast8();
                        if (player_alive)
                ...
                if (projectile_spr.getGlobalBounds().intersects(asteroid9.getGlobalBounds()))
                {
                        projectile_spr_reset();
                        reset_ast9();
                        if (player_alive)
